...
public class Flicker : MonoBehaviour
{
    ...
    private IEnumerator DoFlicker()
    {
        ...
        {
            _lightSource.intensity = Mathf.Lerp(0, _baseIntensity, candle.lerpT) + Mathf.Lerp(_lightSource.intensity, Random.Range(_baseIntensity - MaxReduction, _baseIntensity + MaxIncrease), Strength * Time.deltaTime);
